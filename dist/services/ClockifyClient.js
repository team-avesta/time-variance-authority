...
class ClockifyClient {
    ...
    async getTimeEntries(workspaceId, userId, startDate, endDate) {
        console.log(`Fetching entries for ${userId} from ${startDate.format()} to ${endDate.format()}`);
...
exports.ClockifyClient = ClockifyClient;
//# sourceMappingURL=ClockifyClient.js.map